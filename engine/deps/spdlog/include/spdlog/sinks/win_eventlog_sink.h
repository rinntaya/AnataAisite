...
// Writing to Windows Events Log requires the registry entries below to be present, with the
...
// Please refer to Events Log functions descriptions in MSDN for more details on custom message
// files.
